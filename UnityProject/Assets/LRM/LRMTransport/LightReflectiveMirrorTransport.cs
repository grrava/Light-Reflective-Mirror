...
namespace LightReflectiveMirror
{
    ...
    public partial class LightReflectiveMirrorTransport : Transport
    {
        ...
        public bool IsNATPunchReady => useNATPunch && _NATIP != null;
                        ...
                        if (useNATPunch && GetLocalIp() != null && _directConnectModule != null)
                        {
                            ...
                            if (_NATPuncher == null)
                            {
                                ...
                                while (true)
                                {
                                    try
                                    {
                                        _NATIP = new IPEndPoint(IPAddress.Any, UnityEngine.Random.Range(16000, 17000));
                            ...
                            for (int attempts = 0; attempts < NAT_PUNCH_ATTEMPTS; attempts++)
                            {
								...
								{
                                    Debug.Log("Failed to send intial data to nat puncher.");
